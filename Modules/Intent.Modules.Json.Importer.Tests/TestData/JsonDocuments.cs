...
public static class JsonDocuments
{
    ...
    public static string CustomerWithExtraPropertyFile() => Path.Combine(DomainFolder(), "ExtraProperty", "simple-customer.json");
    public static string CustomerWithMissingPropertyFile() => Path.Combine(DomainFolder(), "MissingProperty", "simple-customer.json");
    public static string ProductFile() => Path.Combine(DomainFolder(), "product.json");
    public static string AccountWithExtraPropertyFile() => Path.Combine(ServicesFolder(), "account-with-extra.json");
}
