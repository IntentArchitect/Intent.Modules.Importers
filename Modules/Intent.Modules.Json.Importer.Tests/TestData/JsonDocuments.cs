...
public static class JsonDocuments
{
    ...
    public static string CustomerWithExtraPropertyFile() => Path.Combine(DomainFolder(), "simple-customer-extra.json");
    public static string CustomerWithMissingPropertyFile() => Path.Combine(DomainFolder(), "simple-customer-missing.json");
