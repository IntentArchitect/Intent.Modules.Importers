...
public class RdbmsStereotypeApplicator
{
    public void ApplyTableDetails(ImportConfiguration config, TableSchema table, ElementPersistable @class)
    {
    ...
    public void ApplyViewDetails(ViewSchema view, ElementPersistable @class)
    {
    ...
    public void ApplyPrimaryKey(ColumnSchema column, ElementPersistable attribute)
    {
    ...
    public void ApplyColumnDetails(ColumnSchema column, ElementPersistable attribute)
    {
    ...
    public void ApplyTextConstraint(ColumnSchema column, ElementPersistable attribute)
    {
    ...
    public void ApplyDecimalConstraint(ColumnSchema column, ElementPersistable attribute)
    {
    ...
    public void ApplyDefaultConstraint(ColumnSchema column, ElementPersistable attribute)
    {
    ...
    public void ApplyComputedValue(ColumnSchema column, ElementPersistable attribute)
    {
    ...
    public void ApplyStoredProcedureSettings(StoredProcedureSchema sqlStoredProc, ElementPersistable elementStoredProc)
    {
