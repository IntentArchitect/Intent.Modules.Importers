...
internal static class StereotypeExtensions
{
        ...
        Action<StereotypePersistable>? initAction = null)
    {
        ...
        if (stereotype == null)
        {
            if (initAction == null)
            {
                throw new InvalidOperationException($"Stereotype Definition Id [{stereotypeDefinitionId}] cannot be found and cannot be created without {nameof(initAction)} being specified");
            }
