...
internal static class Elements
{
    ...
    public static ElementPersistable CategoryTable(string? id = null) => new()
    {
        ...
        SpecializationType = ClassModel.SpecializationType,
        SpecializationTypeId = ClassModel.SpecializationTypeId,
        ExternalReference = ModelNamingUtilities.GetTableExternalReference("dbo", "Category"),
        Stereotypes = new List<StereotypePersistable>
        {
            Stereotypes.Table("dbo", "Category")
        },
        ChildElements = new List<ElementPersistable>
        {
            Attribute("CategoryId", "int", ModelNamingUtilities.GetColumnExternalReference("dbo", "Category", "CategoryID"), isPrimaryKey: true),
            Attribute("Name", "string", ModelNamingUtilities.GetColumnExternalReference("dbo", "Category", "Name"))
        }
    };

    /// <summary>
    /// Item table element with an auto-generated FK to Category
    /// </summary>
    public static ElementPersistable ItemTableWithAutoGeneratedFK(string? id = null) => new()
    {
        Id = id ?? Guid.NewGuid().ToString(),
        Name = "Item",
        SpecializationType = ClassModel.SpecializationType,
        SpecializationTypeId = ClassModel.SpecializationTypeId,
        ExternalReference = ModelNamingUtilities.GetTableExternalReference("dbo", "Item"),
        Stereotypes = new List<StereotypePersistable>
        {
            Stereotypes.Table("dbo", "Item")
        },
        ChildElements = new List<ElementPersistable>
        {
            Attribute("ItemId", "int", ModelNamingUtilities.GetColumnExternalReference("dbo", "Item", "ItemID"), isPrimaryKey: true),
            Attribute("CategoryId", "int", ModelNamingUtilities.GetColumnExternalReference("dbo", "Item", "CategoryID")),
            Attribute("Description", "string", ModelNamingUtilities.GetColumnExternalReference("dbo", "Item", "Description"))
        }
    };
}
