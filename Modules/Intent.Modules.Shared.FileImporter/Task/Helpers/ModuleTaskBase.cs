    ...
    where TInputModel : class
{
    ...
    protected abstract ExecuteResult<TOutputModel> ExecuteModuleTask(TInputModel importModel);
    ...
    private static string GetResultString<T>(ExecuteResult<T> executeResult)
    {
