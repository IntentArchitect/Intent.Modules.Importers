...
public class ClassElementBuilder : ElementBuilderBase
{
    ...
    public ClassElementBuilder(ImportProfileConfig profile, string externalReference, string name, BuilderMetadataManager builderMetadataManager)
    {
        ...
        _element = ElementPersistable.Create(
            specializationType: profile.ClassToSpecializationType,
            specializationTypeId: profile.ClassToSpecializationTypeId,
            name: name,
            parentId: null,
    ...
    public ClassElementBuilder AddConstructor<TCtor>(TCtor dataSource, Action<ConstructorElementBuilder<TCtor>> constructorBuilderAction)
    {
        ...
        _element.ChildElements.Add().AddElement(result);
