...
internal static class StereotypeExtensions
{
        ...
        if (stereotype == null)
        {
            if (initAction == null)
            {
                throw new InvalidOperationException(
                    $"Stereotype Definition Id [{stereotypeDefinitionId}] cannot be found and cannot be created without {nameof(initAction)} being specified");
            }
        ...
        Action<StereotypePropertyPersistable>? initAction = null)
    {
        ...
        if (property == null)
        {
            ...
            {
                throw new InvalidOperationException(
                    $"Stereotype Definition Id [{stereotype.DefinitionId}] cannot create a property with Id [{propertyId}] without {nameof(initAction)} being specified");
            }
