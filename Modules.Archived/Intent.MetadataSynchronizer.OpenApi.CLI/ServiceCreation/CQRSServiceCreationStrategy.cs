    ...
    internal class CQRSServiceCreationStrategy : ServiceCreationStrategyBase, IServiceCreationStrategy
    {
        ...
        {           
            ...
            foreach (var serviceDefinition in serviceDefinitions)
            {
                ...
                {
                    Logging.LogWarning($"Unable to create endpoint for ({serviceDefinition.ServiceName}.{serviceDefinition.OperationName}) array based body can't be represented as a Command.");
                    continue;
                }
