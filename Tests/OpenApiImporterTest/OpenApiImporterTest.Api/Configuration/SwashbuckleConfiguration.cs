...
using OpenApiImporterTest.Api.Filters;
using OpenApiImporterTest.Application;
using OpenApiImporterTest.Domain.Common.Exceptions;
...
namespace OpenApiImporterTest.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthAppName("OpenApiImporterTest API");
