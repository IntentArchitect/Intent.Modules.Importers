...
{
    public class UuidGenerateV5ResponseConfiguration : IEntityTypeConfiguration<UuidGenerateV5Response>
    {
        public void Configure(EntityTypeBuilder<UuidGenerateV5Response> builder)
        {
