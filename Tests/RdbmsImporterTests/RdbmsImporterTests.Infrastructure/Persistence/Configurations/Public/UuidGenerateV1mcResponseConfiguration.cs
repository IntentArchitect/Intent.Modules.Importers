...
{
    public class UuidGenerateV1mcResponseConfiguration : IEntityTypeConfiguration<UuidGenerateV1mcResponse>
    {
        public void Configure(EntityTypeBuilder<UuidGenerateV1mcResponse> builder)
        {
