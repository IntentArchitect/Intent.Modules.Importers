...
{
    public class UuidGenerateV1ResponseConfiguration : IEntityTypeConfiguration<UuidGenerateV1Response>
    {
        public void Configure(EntityTypeBuilder<UuidGenerateV1Response> builder)
        {
