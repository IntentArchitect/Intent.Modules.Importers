...
namespace RdbmsImporterTests.Infrastructure.Repositories.PsgSchema2
{
    ...
    public class CustomerRepository : RepositoryBase<Customer, Customer, PostgresAppDbContext>, ICustomerRepository
    {
        public CustomerRepository(PostgresAppDbContext dbContext, IMapper mapper) : base(dbContext, mapper)
        {
        }
