...
namespace RdbmsImporterTests.Infrastructure.Repositories.PsgSchema2
{
    [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
    public class BankRepository : RepositoryBase<Bank, Bank, PostgresAppDbContext>, IBankRepository
    {
        public BankRepository(PostgresAppDbContext dbContext, IMapper mapper) : base(dbContext, mapper)
        {
        }
        ...
        public async Task<Bank?> FindByIdAsync(
            Guid id,
            Func<IQueryable<Bank>, IQueryable<Bank>> queryOptions,
            CancellationToken cancellationToken = default)
        {
