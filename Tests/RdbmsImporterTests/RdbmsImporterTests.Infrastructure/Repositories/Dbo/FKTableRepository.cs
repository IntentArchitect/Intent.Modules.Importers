...
namespace RdbmsImporterTests.Infrastructure.Repositories.Dbo
{
    ...
    public class FKTableRepository : RepositoryBase<FKTable, FKTable, ApplicationDbContext>, IFKTableRepository
    {
        public FKTableRepository(ApplicationDbContext dbContext, IMapper mapper) : base(dbContext, mapper)
        {
        }
