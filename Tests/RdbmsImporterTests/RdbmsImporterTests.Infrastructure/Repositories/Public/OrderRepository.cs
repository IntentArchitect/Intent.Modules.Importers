...
namespace RdbmsImporterTests.Infrastructure.Repositories.Public
{
    ...
    public class OrderRepository : RepositoryBase<Order, Order, PostgresAppDbContext>, IOrderRepository
    {
        public OrderRepository(PostgresAppDbContext dbContext, IMapper mapper) : base(dbContext, mapper)
        {
        }
