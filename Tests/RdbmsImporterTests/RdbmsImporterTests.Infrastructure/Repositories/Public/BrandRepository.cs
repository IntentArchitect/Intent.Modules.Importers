...
namespace RdbmsImporterTests.Infrastructure.Repositories.Public
{
    ...
    public class BrandRepository : RepositoryBase<Brand, Brand, PostgresAppDbContext>, IBrandRepository
    {
        public BrandRepository(PostgresAppDbContext dbContext, IMapper mapper) : base(dbContext, mapper)
        {
        }
