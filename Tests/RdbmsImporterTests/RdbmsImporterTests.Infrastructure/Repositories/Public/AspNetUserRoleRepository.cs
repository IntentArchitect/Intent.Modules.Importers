...
namespace RdbmsImporterTests.Infrastructure.Repositories.Public
{
    ...
    public class AspNetUserRoleRepository : RepositoryBase<AspNetUserRole, AspNetUserRole, PostgresAppDbContext>, IAspNetUserRoleRepository
    {
        public AspNetUserRoleRepository(PostgresAppDbContext dbContext, IMapper mapper) : base(dbContext, mapper)
        {
        }
