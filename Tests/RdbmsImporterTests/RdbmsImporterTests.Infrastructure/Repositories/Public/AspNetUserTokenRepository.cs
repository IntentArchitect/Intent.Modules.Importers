...
namespace RdbmsImporterTests.Infrastructure.Repositories.Public
{
    ...
    public class AspNetUserTokenRepository : RepositoryBase<AspNetUserToken, AspNetUserToken, PostgresAppDbContext>, IAspNetUserTokenRepository
    {
        public AspNetUserTokenRepository(PostgresAppDbContext dbContext, IMapper mapper) : base(dbContext, mapper)
        {
        }
