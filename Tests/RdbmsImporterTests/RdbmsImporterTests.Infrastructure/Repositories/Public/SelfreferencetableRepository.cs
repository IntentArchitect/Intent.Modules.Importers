...
namespace RdbmsImporterTests.Infrastructure.Repositories.Public
{
    ...
    public class SelfreferencetableRepository : RepositoryBase<Selfreferencetable, Selfreferencetable, PostgresAppDbContext>, ISelfreferencetableRepository
    {
        public SelfreferencetableRepository(PostgresAppDbContext dbContext, IMapper mapper) : base(dbContext, mapper)
        {
        }
