...
namespace RdbmsImporterTests.Infrastructure.Repositories.Public
{
    ...
    public class ProductRepository : RepositoryBase<Product, Product, PostgresAppDbContext>, IProductRepository
    {
        public ProductRepository(PostgresAppDbContext dbContext, IMapper mapper) : base(dbContext, mapper)
        {
        }
