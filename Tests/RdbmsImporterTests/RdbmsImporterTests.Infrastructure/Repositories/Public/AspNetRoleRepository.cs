...
namespace RdbmsImporterTests.Infrastructure.Repositories.Public
{
    ...
    public class AspNetRoleRepository : RepositoryBase<AspNetRole, AspNetRole, PostgresAppDbContext>, IAspNetRoleRepository
    {
        public AspNetRoleRepository(PostgresAppDbContext dbContext, IMapper mapper) : base(dbContext, mapper)
        {
        }
        ...
        public async Task<AspNetRole?> FindByIdAsync(
            string id,
            Func<IQueryable<AspNetRole>, IQueryable<AspNetRole>> queryOptions,
            CancellationToken cancellationToken = default)
        {
