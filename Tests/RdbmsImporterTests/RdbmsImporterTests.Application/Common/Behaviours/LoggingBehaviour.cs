...
namespace RdbmsImporterTests.Application.Common.Behaviours
{
        ...
        where TRequest : notnull
    {
        ...
        public Task Process(TRequest request, CancellationToken cancellationToken)
        {
            ...
            {
                _logger.LogInformation("RdbmsImporterTests Request: {Name} {@UserId} {@UserName} {@Request}", requestName, userId, userName, request);
            }
            else
            {
                _logger.LogInformation("RdbmsImporterTests Request: {Name} {@UserId} {@UserName}", requestName, userId, userName);
            }
