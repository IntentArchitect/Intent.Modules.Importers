...
{
    internal class AttributeValueDocument : IAttributeValueDocument
    {
        ...
        public AttributeValue ToEntity(AttributeValue? entity = default)
        {
        ...
        public AttributeValueDocument PopulateFromEntity(AttributeValue entity)
        {
            Id = entity.Id;
            Value = entity.Value;
        ...
        public static AttributeValueDocument? FromEntity(AttributeValue? entity)
        {
            if (entity is null)
            {
                return null;
            ...
            return new AttributeValueDocument().PopulateFromEntity(entity);
        }
    }
}